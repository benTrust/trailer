...
class SignUp extends Component{
        ...
        return (
            <div>
                ...
                <form onSubmit = {handleSubmit(this.props.signUp.bind(this))}>
                    ...
                    <button type = "submit" className = "btn btn-primary" disabled = {this.props.invalid}>S'enregistrer</button>
                </form>
            </div>
        )
    }
    ...
    getInfoErrorIfHas(){
        if(this.props.userFailed && this.props.userFailed.sign == 'up'){
...
export default connect(mapStateToProps, mapDispatchToProps)(reduxForm(formConfig)(SignUp))